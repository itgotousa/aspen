...
struct _Has_m_clrForeColor : ::std::false_type{};

template <class T>
struct _Has_m_clrForeColor<T, ::std::void_t<decltype(T::m_clrForeColor)>> : ::std::true_type{};

template <class T, class = void>
struct _Has_m_clrBackColor : ::std::false_type{};

template <class T>
struct _Has_m_clrBackColor<T, ::std::void_t<decltype(T::m_clrBackColor)>> : ::std::true_type{};

template <class T, class = void>
struct _Has_m_nAppearance : ::std::false_type{};

template <class T>
struct _Has_m_nAppearance<T, ::std::void_t<decltype(T::m_nAppearance)>> : ::std::true_type{};

template <class T, class = void>
struct _Has_m_wndReflector : ::std::false_type{};

template <class T>
struct _Has_m_wndReflector<T, ::std::void_t<decltype(T::m_wndReflector)>> : ::std::true_type{};

template <class T, class = void>
struct _Has_m_pFont : ::std::false_type{};

template <class T>
struct _Has_m_pFont<T, ::std::void_t<decltype(T::m_pFont)>> : ::std::true_type{};

template <class T, class = void>
struct _Has_OnFontChanged : ::std::false_type{};

template <class T>
struct _Has_OnFontChanged<T, ::std::void_t<decltype(::std::declval<T>().OnFontChanged())>> : ::std::true_type{};

template <class T, class = void>
struct _Has_m_pPicture : ::std::false_type{};

template <class T>
struct _Has_m_pPicture<T, ::std::void_t<decltype(T::m_pPicture)>> : ::std::true_type{};

template <class T, class = void>
struct _Has_OnPictureChanged : ::std::false_type{};

template <class T>
struct _Has_OnPictureChanged<T, ::std::void_t<decltype(::std::declval<T>().OnPictureChanged())>> : ::std::true_type{};

template <class T, class = void>
struct _Has_m_pMouseIcon : ::std::false_type{};

template <class T>
struct _Has_m_pMouseIcon<T, ::std::void_t<decltype(T::m_pMouseIcon)>> : ::std::true_type{};

template <class T, class = void>
struct _Has_OnMouseIconChanged : ::std::false_type{};

template <class T>
struct _Has_OnMouseIconChanged<T, ::std::void_t<decltype(::std::declval<T>().OnMouseIconChanged())>> : ::std::true_type{};

template <class T, class = void>
struct _Has_m_hWnd : ::std::false_type{};

template <class T>
struct _Has_m_hWnd<T, ::std::void_t<decltype(T::m_hWnd)>> : ::std::true_type{};
#endif // _ATL_MODULES
...
#ifdef _ATL_MODULES
		if constexpr (_Has_m_clrForeColor<T>::value)
#else // ^^^ _ATL_MODULES / !_ATL_MODULES vvv
...
#ifdef _ATL_MODULES
		if constexpr (_Has_m_clrBackColor<T>::value)
#else // ^^^ _ATL_MODULES / !_ATL_MODULES vvv
...
#ifdef _ATL_MODULES
		if constexpr (_Has_m_nAppearance<T>::value)
#else // ^^^ _ATL_MODULES / !_ATL_MODULES vvv
...
#define IMPLEMENT_STOCKPROP(type, fname, pname, dispid) \
	...
	struct _Has_m_##pname : ::std::false_type{}; \
	template <class _Ty> \
	struct _Has_m_##pname<_Ty, ::std::void_t<decltype(_Ty::m_##pname)>> : ::std::true_type{}; \
	template <class _Ty, class = void> \
	struct _Has_On##fname##Changed : ::std::false_type{}; \
	template <class _Ty> \
	struct _Has_On##fname##Changed<_Ty, ::std::void_t<decltype(::std::declval<_Ty>().On##fname##Changed())>> : ::std::true_type{}; \
	HRESULT STDMETHODCALLTYPE put_##fname(_In_ type pname) \
	{ \
		if constexpr (_Has_m_##pname<T>::value) \
		{ \
			...
			if constexpr (_Has_On##fname##Changed<T>::value) \
			{ \
				pT->On##fname##Changed(); \
			} \
			pT->FireViewChange(); \
...
public:
	...
	{
#ifdef _ATL_MODULES
		if constexpr (_Has_m_pFont<T>::value)
#else // ^^^ _ATL_MODULES / !_ATL_MODULES vvv
...
#ifdef _ATL_MODULES
			if constexpr (_Has_OnFontChanged<T>::value)
#else // ^^^ _ATL_MODULES / !_ATL_MODULES vvv
	...
	{
#ifdef _ATL_MODULES
		if constexpr (_Has_m_pPicture<T>::value)
#else // ^^^ _ATL_MODULES / !_ATL_MODULES vvv
...
#ifdef _ATL_MODULES
			if constexpr (_Has_OnPictureChanged<T>::value)
#else // ^^^ _ATL_MODULES / !_ATL_MODULES vvv
	...
	{
#ifdef _ATL_MODULES
		if constexpr (_Has_m_pMouseIcon<T>::value)
#else // ^^^ _ATL_MODULES / !_ATL_MODULES vvv
...
#ifdef _ATL_MODULES
			if constexpr (_Has_OnMouseIconChanged<T>::value)
#else // ^^^ _ATL_MODULES / !_ATL_MODULES vvv
	...
	{
#ifdef _ATL_MODULES
		if constexpr (_Has_m_hWnd<T>::value)
#else // ^^^ _ATL_MODULES / !_ATL_MODULES vvv
