#ifndef __DUICHECKED_H__
#define __DUICHECKED_H__
...
inline void __cdecl tmakepath_s(
	...
	_In_ size_t _SizeInChars,
	_In_opt_z_ const TCHAR *_Drive,
	_In_opt_z_ const TCHAR *_Dir,
	_In_opt_z_ const TCHAR *_Fname,
	_In_opt_z_ const TCHAR *_Ext)
{
