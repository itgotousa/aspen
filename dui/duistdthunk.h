#ifndef __DUISTDTHUNK_H__
#define __DUISTDTHUNK_H__
...
// avoid ODR violations
	...
	typedef class DDynamicStdCallThunk2 DDynamicStdCallThunk; class DDynamicStdCallThunk2
#else
	class DDynamicStdCallThunk
#endif
	{
	public:
#ifdef USE_ATL_THUNK2
...
#ifdef USE_ATL_THUNK2
		DDynamicStdCallThunk2()
#else
		DDynamicStdCallThunk()
#endif
		{
			pThunk = NULL;
		}
...
#pragma pack(pop)
	typedef DDynamicStdCallThunk DStdCallThunk;

}
#pragma pop_macro("new")

#endif /* __DUISTDTHUNK_H__ */
